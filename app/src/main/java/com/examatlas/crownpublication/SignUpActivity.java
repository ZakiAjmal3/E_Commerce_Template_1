...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextBtn = findViewById(R.id.btnSignUp);

        CheckBox checkBox = findViewById(R.id.whatsAppCheckBox);
        Drawable drawable = null;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            drawable = checkBox.getButtonDrawable();
        }
        if (drawable != null) {
            drawable.setColorFilter(ContextCompat.getColor(this, R.color.yellow), PorterDuff.Mode.SRC_IN);
        }
...
// On Item Selected Listener for the States Spinner
        stateSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                ...
                ArrayAdapter<String> cityAdapter = new ArrayAdapter<>(SignUpActivity.this, android.R.layout.simple_spinner_item, cities);
