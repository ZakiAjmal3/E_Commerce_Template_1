...
public class ChoosingPaymentMethod extends AppCompatActivity {
...
//        Log.e("singleBookProductId",singleBookProductId);
        ...
        cashOnDeliveryRL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isCODClicked){
                    ...
                    cashOnDeliveryRL.setBackgroundColor(ContextCompat.getColor(ChoosingPaymentMethod.this,R.color.white));
                    codCardView.setVisibility(View.GONE);
                    isCODClicked = false;
                    upiArrow.setImageResource(R.drawable.ic_down);
                    upiRL.setBackgroundColor(ContextCompat.getColor(ChoosingPaymentMethod.this,R.color.white));
                    upiCardView.setVisibility(View.GONE);
                    isUPIClicked = false;
                }else {
                    codArrow.setImageResource(R.drawable.ic_up);
                    cashOnDeliveryRL.setBackgroundColor(ContextCompat.getColor(ChoosingPaymentMethod.this,R.color.light_dark_grey));
        ...
        upiRL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isUPIClicked){
                    ...
                    upiRL.setBackgroundColor(ContextCompat.getColor(ChoosingPaymentMethod.this,R.color.light_dark_grey));
        ...
        codBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                codOrUpi = "COD";
                progressDialog = new Dialog(ChoosingPaymentMethod.this);
    ...
    public void orderCheckOut(){
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, checkOutURL, jsonObject,
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (codOrUpi.equals("upi")) {
                                Intent intent = new Intent(ChoosingPaymentMethod.this, BookOrderPaymentActivity.class);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(ChoosingPaymentMethod.this, errorMessage, Toast.LENGTH_SHORT).show();
                ...
                if (error.networkResponse != null) {
                    try {
                        ...
                        Toast.makeText(ChoosingPaymentMethod.this, message, Toast.LENGTH_LONG).show();
...
//                        Toast.makeText(CartViewActivity.this, error.toString(), Toast.LENGTH_SHORT).show();
                        ...
                        if (error.networkResponse != null) {
                            try {
                                ...
                                e.printStackTrace();
                                Toast.makeText(ChoosingPaymentMethod.this, e.toString(), Toast.LENGTH_SHORT).show();
                            }
                        }
    ...
    private void clearCartApi(String orderId) {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (success.equals("true")) {
                                ...
                                Intent intent = new Intent(ChoosingPaymentMethod.this, OrderSuccessFullyPlacedActivity.class);
        ...
        MySingleton.getInstance(ChoosingPaymentMethod.this).addToRequestQueue(jsonObjectRequest);
    }
}