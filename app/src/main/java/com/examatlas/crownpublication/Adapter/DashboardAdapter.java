...
public class DashboardAdapter extends RecyclerView.Adapter<DashboardAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull DashboardAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        DashboardModel currentBook = hardBookECommPurchaseModelArrayList.get(hardBookECommPurchaseModelArrayList.size() - 1 - position);
    ...
    private void addToWishlist(DashboardModel currentBook) {
